...
public class BookDTO {
    ...
    @Size(max = 2000, message = "Description mist not exceed 2000 characters")
    ...
    @Digits(integer = 8, fraction = 2, message = "Price must have at most 8 integer digits")
    private BigDecimal price;

    @Size(max = 500, message = "Image URL mist not exceed 500 characters")
